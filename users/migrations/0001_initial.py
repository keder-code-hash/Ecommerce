    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ph_NO_code', models.CharField(max_length=50)),
                ('ph_NO', models.CharField(max_length=50)),
                ('gender', models.CharField(choices=[('ML', 'MALE'), ('FM', 'FEMALE'), ('PN', 'PREFERS NOT TO SAY'), ('OT', 'OTHERS')], default='PN', max_length=2)),
                ('address', models.ManyToManyField(blank=True, related_name='address', to='users.useraddressmodel', verbose_name='user address')),
                ('delivery_address', models.ManyToManyField(blank=True, related_name='delivery_address', to='users.useraddressmodel', verbose_name='user delivery address')),
